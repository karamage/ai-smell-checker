...
export function App() {
  ...
  return (
    <>
      <SmokeCanvas
        intensity={intensity}
        color={report.tooShort ? "#7c3aed" : report.level.color}
      />
      ...
      <div
        ...
        style={
          {
            "--level": report.tooShort ? "#7c3aed" : report.level.color,
            ...
            <div className="editor-col">
              <div className="toolbar">
                ...
                <span className="chars">
                  {report.length.toLocaleString()} 字
                </span>
              </div>
              <Editor
                text={text}
